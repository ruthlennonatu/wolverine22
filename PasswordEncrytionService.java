...
public class PasswordEncrytionService {
...
//DO NOT CHANGE THIS METHOD UNLESS TO ADD PRINT STATEMENTS
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, InvalidKeySpecException {
                   ...
                   String AttemptedPassword = "12345678";
                   ...
                   System.out.println("password is salted = " + getEncryptedPassword(password, generateSalt()));
                   System.out.println("the passwords match = " +authenticate(AttemptedPassword, encryptedPassword, salt));
